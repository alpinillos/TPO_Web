			...
			<div id="titulo-template"></div>
				<div id="contenedor-divLogin">
					...
					<div id="divData">
						...
						<div id="Jugadores">
							<span id="lblJugadores">Jugador1</span> <br /> 
						    <input type="radio" name="grupo" value="grupo1" checked> Truco<br>
						    <img src="images/1_ESPADA.jpg" alt="8 de Oro" style="">
						</div>
					...
					<div id="divData">
						...
						<div id="Jugadores">
							<span id="lblJugadores">Jugador2</span> <br /> 
						    <input type="radio" name="grupo" value="grupo1" checked> Truco<br>
						    <img src="images/8_ORO.jpg" alt="8 de Oro" style="">
						</div>

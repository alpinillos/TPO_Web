...
<body>
	...
	<div id="contene" style="width: 960px; margin: auto;">
		<div id="contenedor-template">
			<div id="titulo-template">Iniciar Sesión</div>
			<div id="Tabs">
				<button id="btnJugadorExistente" class="cssbox5">Jugador
					existente</button>

			</div>
			<div id="Tabs"></div>
			<div id="Tabs">
				<button id="btnRegistrarme" class="cssbox5">Registrarme</button>
			...
			<div id="divLogin">
				<div id="contenedor-divLogin">
					...
					<div id="divData">
						...
						<div id="password">
							<span id="lblPassword">Password</span> <br /> <input
								type="text" id="txtPassword" name="txtPassword">

						</div>
						<div id="btn-continuar">
							<button class="cssbox2" id="btnConnectar">Conectar</button>
